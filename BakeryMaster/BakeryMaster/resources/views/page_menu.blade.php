...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
      <div class="container">
        <a class="navbar-brand" href="{{ url('/page_beranda_pembeli') }}">Bakery</a>
        ...
        <?php if (Session::has('pembeli')): ?>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item active"><a href="{{ url('/page_kantin') }}" class="nav-link">Product</a></li>
...
<div class="hero-wrap ftco-degree-bg header" style="background-image: url('{{ url('theme-assets/brod.jpg') }}');" data-stellar-background-ratio="0.5">
        ...
        <div class="row mb-5">
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
              ...
              <p>Sebuah web aplikasi yang dibuat untuk memudahkan Bakery dalam melakukan pememesan Roti agar tidak lama menunggu dan mengantri panjang.</p>
            ...
            <div class="ftco-footer-widget mb-4">
              ...
              <div class="block-23 mb-3">
                <ul>
                  ...
                  <li><a href="#"><span class="icon icon-envelope pr-4"></span><span class="text">Bakery@gmail.com</span></a></li>
                </ul>
              </div>
            </div>
          </div>
